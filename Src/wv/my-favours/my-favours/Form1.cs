...
namespace my_favours
{
    public partial class Form1 : Form
    {
        ...
        private async void Form1_Load(object sender, EventArgs e)
        {
            ...
            filepath = @"file:///" + System.Reflection.Assembly.GetEntryAssembly().Location.Replace("\\", "/").Replace("my-favours.exe", "") + "assets/index.html";
...
".Replace("\r\n", " ").Replace("savedstorage", savedstorage);
    ...
    getScript('https://appassets/jquery.min.js', function () {
        ...
        scriptbootstrap.src = 'https://appassets/bootstrap.min.js'; 
        document.head.appendChild(scriptbootstrap);
        var scriptiframe = document.createElement('script'); 
        scriptiframe.src = 'https://appassets/iframe_api.js'; 
